...
# logo_tag_list = soup.findAll("a", {"id": "logo"})         # 第一種寫法
logo_tag_list = soup.findAll("a", id="logo")              # 第二種寫法

print(logo_tag_list[0])      # 標籤物件
print(logo_tag_list[0].text)      # 取得標籤物件裡的字串
print("http://www.ptt.cc" + logo_tag_list[0]["href"])        # 取得標籤物件裡的網址
       # 填上完整的網址
